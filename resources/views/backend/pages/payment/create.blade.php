                                ...
                                <div class="portlet-body">
                                    <div class="form-horizontal">
                                        <div class="form-group required">
                                            ...
                                            <div class="col-md-7">
                                                <input type="number" id="total_amount" class="form-control" name="total_amount" required readonly value="10">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group required">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" id="currency" class="form-control" name="currency" required readonly value="BDT">
                                            </div>
                                        </div>
                                    </div>
                                </div>
